...
PARAMS = -v -trimpath -ldflags "-X 'github.com/yafromil88/sing-box/constant.Version=$(VERSION)' -s -w -buildid="
...
lib_install:
	go install -v github.com/yafromil88/gomobile/cmd/gomobile@v0.1.5
	go install -v github.com/yafromil88/gomobile/cmd/gobind@v0.1.5
