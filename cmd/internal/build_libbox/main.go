...
import (
	...
	_ "github.com/fromil88/gomobile"
...
func init() {
	...
	sharedFlags = append(sharedFlags, "-ldflags", "-X github.com/yafromil88/sing-box/constant.Version="+currentTag+" -s -w -buildid=")
	debugFlags = append(debugFlags, "-ldflags", "-X github.com/yafromil88/sing-box/constant.Version="+currentTag)
